 ...
 * useful when only the input or output end of a Queue is to be exposed by an API; it means that the full implementation
 * of the Queue can remain hidden.
 *
 * <pre><p/><table id="crc"><caption>CRC Card</caption>
 * <tr><th> Responsibilities </th></tr>
 * <tr><td> Expose a queue as a sink. </td></tr>
 * <tr><td> Expose a queue as a source. </td></tr>
 * </table></pre>
 */
