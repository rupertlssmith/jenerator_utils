 ...
 * </table></pre>
 */
public class DropWizardTopGenerator extends BaseGenerator implements EntityTypeVisitor {
    /** Defines the name of the template group for creating local service interfaces. */
    private static final String DROPWIZARD_APPLICATION_TEMPLATES_GROUP = "DropWizardApplication";
     ...
     */
    public DropWizardTopGenerator(String templateDir) {
        super(templateDir);
